...
onload = function () {
     ...
     */
     // pagex check relative to the canvas element
     //clientx checks relative to the document 
     // this funciton just checks for the current mouse location and its relation to the place where we want it to click in the canvas
